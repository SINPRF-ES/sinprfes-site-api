...
-- 1. Ensure canonical fields exist in filiados
ALTER TABLE filiados ADD COLUMN IF NOT EXISTS sexo VARCHAR(1);
ALTER TABLE filiados ADD COLUMN IF NOT EXISTS siape VARCHAR(10);
...
CREATE TABLE IF NOT EXISTS report_jobs (
    ...
    params JSONB,
    requester_id INTEGER REFERENCES filiados(id),
