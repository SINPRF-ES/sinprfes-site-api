...
async function seed() {
  ...
  try {
    ...
    const users = [
      ...
      { nome: "Membro Um", cpf: "33333333333", perfil: "CONSELHEIRO" },
      { nome: "Membro Dois", cpf: "44444444444", perfil: "CONSELHEIRO" },
      { nome: "Membro Três", cpf: "55555555555", perfil: "CONSELHEIRO" },
      { nome: "Membro Quatro", cpf: "66666666666", perfil: "CONSELHEIRO" },
      { nome: "Membro Cinco", cpf: "77777777777", perfil: "CONSELHEIRO" },
