...
- **Push Notifications v2**: Adicionado suporte a filtros de público (LOTACAO, JOGOS, USER). Histórico agora exibe métricas de `noTokenOrDenied`. Implementada retenção automática de 60 dias para o histórico de campanhas.
