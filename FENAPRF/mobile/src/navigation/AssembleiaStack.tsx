...
import VisualizarTokenScreen from '../screens/assembleia/VisualizarTokenScreen';
...
export default function AssembleiaStack() {
  return (
    <Stack.Navigator screenOptions={({ navigation }) => ({
      ...
      <Stack.Screen name="VisualizarToken" component={VisualizarTokenScreen} options={{ headerShown: false }} />
