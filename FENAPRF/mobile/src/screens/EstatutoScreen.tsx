...
const TOC_ITEMS = [
  ...
  { id: 'cap2', label: 'Capítulo II - Foro e Sede' },
  { id: 'cap3', label: 'Capítulo III - Objetivos' },
  { id: 'cap4', label: 'Capítulo IV - Prerrogativas e Deveres' },
  { id: 'cap5', label: 'Capítulo V - Sindicalizados' },
  { id: 'cap6', label: 'Capítulo VI - Sindicatos Regionais' },
  { id: 'cap7', label: 'Capítulo VII - Requisitos para Filiação' },
  { id: 'cap8', label: 'Capítulo VIII - Requisitos para Desfiliação' },
  { id: 'cap9', label: 'Capítulo IX - Direitos Sindicais' },
  { id: 'cap10', label: 'Capítulo X - Deveres Sindicais' },
  { id: 'cap11', label: 'Capítulo XI - Sanções' },
  { id: 'cap12', label: 'Capítulo XII - Organização Federativa' },
  { id: 'cap13', label: 'Capítulo XIII - Conselho de Representantes' },
  ...
  { id: 'cap19', label: 'Capítulo XIX - Vacância e Impedimentos' },
